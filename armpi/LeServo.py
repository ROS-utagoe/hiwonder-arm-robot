...
class PWM_Servo(object): #class定义一个类，object在python3中默认加
    ...
    def __init__(self, pi, pin, freq = 50, min_width = 500, max_width=2500, deviation=0, position = 1500, control_speed=False):
        ...
        self.Position = position  #舵机当前位置值
        ...
        if control_speed is True: #当运行速度改变时
            self.t = threading.Thread(target=PWM_Servo.updatePosition, args=(self,))
